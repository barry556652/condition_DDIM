...
from DDIM.unet_attention import SpatialTransformer
...
class UNetModel(nn.Module):
    ...
    def __init__(
        ...
        self.cond_embedding = ConditionalEmbedding(num_labels, channels // 2, d_time_emb)
        self.com_embedding = ConditionalEmbedding(num_labels, channels // 2, d_time_emb)
        self.time_embed = TimeEmbedding(T, channels, d_time_emb)
    ...
    def forward(self, x: torch.Tensor, time_steps: torch.Tensor, labels: torch.Tensor, labels_1: torch.Tensor):
        """
